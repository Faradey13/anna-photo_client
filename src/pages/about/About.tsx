                ...
                <div className={cls.imageContainer}>
                    {isAuth &&
                        <img className={cls.replace}
                             ...
                             alt=""
                             onClick={() => openModal('about_s.webp')}
                        />
                    }
                    <img className={cls.image}
                         src={`${API_URL}/images/main/about_s.webp`}
                         alt="anna_gipp_about"
                    />
                </div>
            }
                ...
                <div>
                    {isAuth && <div style={{position: "relative", width: "100%", height: "100%"}}>
                        <TooltipCreate text={'Добавить пунк обо мне'}
                                       onClick={() => openCreateModalWithKey({keyUniq: '.title', type: 'about'})}/>
                    </div>}
                    <div className={cls.toolTips}>
                        {currentText?.map((section, index) => (
                            <div key={index}>
                                ...
                                <div className={cls.aboutText}>{section.titleText}</div>
                            </div>
                        ))}
                    </div>
                </div>
